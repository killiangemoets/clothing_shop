...
// Gatsby is a framework that is written in React, and it had already combined together some of the best React ecosystem libraries into one bundle
// Gatbsy is really good when you want to build static websites that generally don't need to dynamically change the views that often (exemple: a blog website)
